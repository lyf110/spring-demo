...
public class Result<T> {
    ...
    public static <T> Result<T> error() {
        return new Result<>(StatusCode.FAILURE.message(), StatusCode.FAILURE.code(), null);
    }
    ...
    public static <T> Result<T> error(StatusCode statusCode) {
        return new Result<>(statusCode.message(), statusCode.code(), null);
    }
    ...
    public static <T> Result<T> errorMessage(String message) {
        return new Result<>(message, StatusCode.CUSTOM_FAILURE.code(), null);
    }
}
